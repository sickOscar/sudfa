...
`
        ...
        <div className="row">
          ...
          <div className="col-sm-12">
            ...
            <p>
              <b>Remember</b>, it's a Javascript class like all the others
        ...
        <div className="row mt-3">
          ...
          <div className="col-sm-12">
            ...
            <p>
              The marketer is a smart and powerful character. Despite being the weakest and his physical attack is
